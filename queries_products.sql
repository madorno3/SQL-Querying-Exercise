...
-- 3.INSERT INTO products (name,price,can_be_returned) VALUES ('stool',25.99,'true');
-- 4.SELECT * FROM products;
-- 5.SELECT name FROM products;
-- 6.SELECT name, price FROM products;
-- 7.INSERT INTO products (name,price,can_be_returned) VALUES ('desk',80.00,'true');
-- 8.SELECT name, price, can_be_returned FROM products WHERE can_be_returned = 'true';
-- 9.SELECT name FROM products WHERE price < 44.00;
-- 10.name FROM products WHERE price BETWEEN 22.50 AND 99.99;
